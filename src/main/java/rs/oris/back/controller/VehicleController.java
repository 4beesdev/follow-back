...
public class VehicleController {
    ...
    public Response<Map<String, List<Vehicle>>> getAllVehiclesInactive(@PathVariable("firm_id") int firmId) throws Exception {
        String username = AuthUtil.getCurrentUsername();
        User user = userService.findByUsername(username);
    ...
    public Response<Vehicle> addVehicle(@RequestBody Vehicle vehicle, @PathVariable("firm_id") int firmId) throws Exception {
        String username = AuthUtil.getCurrentUsername();
        User user = userService.findByUsername(username);
...
//    }
    ...
    public boolean deleteVehicle(@PathVariable("vehicle_id") int vehicleId) throws Exception {
        String username = AuthUtil.getCurrentUsername();
        User user = userService.findByUsername(username);
    ...
    public Response<Vehicle> updateVehicle(@PathVariable("vehicle_id") int vehicleId, @RequestBody Vehicle vehicle, @PathVariable("firm_id") int firmId) throws Exception {
        String username = AuthUtil.getCurrentUsername();
        User user = userService.findByUsername(username);
    ...
    public Response<Vehicle> unInActive(@PathVariable("vehicle_id") int vehicleId, @PathVariable("firm_id") int firmId) throws Exception {
        String username = AuthUtil.getCurrentUsername();
        User user = userService.findByUsername(username);
    ...
    public boolean changeVehicleImei(@RequestBody ImeiDTO imeiDTO) throws Exception {
        String username = AuthUtil.getCurrentUsername();
